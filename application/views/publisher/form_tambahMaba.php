			...
			?>
						...
						<form method="POST" action="<?php echo base_url().'index.php/publisher/maba/simpanData'; ?>" enctype="multipart/form-data" onsubmit="return cekform();">		
								<div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/publisher/maba" class="btn btn-success">Tutup</a>
                                    </form>
                                </div>
                        </form>
