			...
			?>
						...
						<form method="POST" action="<?php echo base_url().'index.php/publisher/administrator/updateData'; ?>" enctype="multipart/form-data" onsubmit="return cekform();">		
								<div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/publisher/administrator" class="btn btn-success">Tutup</a>
                                    </form>
                                </div>
                        </form>
            ...
            <script type="text/javascript">
                function cekform() 
                {
                    ...
                    if($("#password1").val() != $("#password2").val())
                    {
                        ...
                        <form method="POST" action="<?php echo base_url().'index.php/publisher/administrator/gantiPassword'; ?>" enctype="multipart/form-data" onsubmit="return cekform();">
                            <div class="col-lg-6">
                                <form role="form">
                                    <div class="form-group">
                                            <label>Kode</label>
