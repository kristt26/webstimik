			...
			?>
						...
						<form method="POST" action="<?php echo base_url().'index.php/admin/tentang/updateData'; ?>" enctype="multipart/form-data" onsubmit="return cekform();">		
								<div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/admin/tentang" class="btn btn-success">Tutup</a>
                                    </form>
                                </div>
                        </form>
