			...
			?>
						...
						<form method="POST" action="<?php echo base_url().'index.php/admin/akademik/updateData'; ?>" enctype="multipart/form-data" onsubmit="return cekform();">		
								<div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            <label>File</label>
                                            <input type="file" name="files" value="<?php echo $file; ?>">
                                        </div>
