...
class Kegiatan extends CI_Controller {
	...
	{ 
		...
		$isi['content'] = 'publisher/kegiatan_view';
		$isi['judul'] = 'kegiatan';
	...
	{
		$this->model_security->getsecurity();
		$isi['content'] = 'publisher/form_tambahKegiatan';
		$isi['menu'] = 'admin/side_publisher';
	...
	public function simpanData()
	{
		...
		redirect('publisher/kegiatan/tambahData');
	}
	...
	public function delete($id)
	{
		...
		redirect('publisher/kegiatan');
	}

	public function editData($id){
		$this->model_security->getsecurity();
		$isi['content'] = 'publisher/form_editKegiatan';
		$isi['menu'] = 'admin/side_publisher';
		$isi['judul'] = 'kegiatan';
