...
class Pengumuman extends CI_Controller {
	...
	{ 
		...
		$isi['content'] = 'publisher/pengumuman_view';
	...
	{
		$this->model_security->getsecurity();
		$isi['content'] = 'publisher/form_tambahPengumuman';
		$isi['menu'] = 'admin/side_publisher';
	...
	public function simpanData()
	{
		...
		redirect('publisher/pengumuman/tambahData');
	}
	...
	//	unlink('./assets/images/pengumuman/'.$row->gambar);
		...
		redirect('publisher/pengumuman');
	}

	public function editData($id){
		$this->model_security->getsecurity();
		$isi['content'] = 'publisher/form_editPengumuman';
		$isi['menu'] = 'admin/side_publisher';
